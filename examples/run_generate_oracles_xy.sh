...
python generate_oracles_xy_mp.py --database_folders ${TRAIN_FOLDER_3} --num_envs 200 --file_start_num 0 --file_type ${FILE_TYPE}
python generate_oracles_xy_mp.py --database_folders ${VALID_FOLDER_3} --num_envs 100 --file_start_num 800 --file_type ${FILE_TYPE}
python generate_oracles_xy_mp.py --database_folders ${TEST_FOLDER_3} --num_envs 70 --file_start_num 900 --file_type ${FILE_TYPE}
