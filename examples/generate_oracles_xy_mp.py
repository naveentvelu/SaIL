...
def generate_save_oracle(e, i, curr_env_file, file_start_num, file_type, env_name, env_folder):
  
  planner_local = ValueIteration()
  print(curr_env_file)
  e.initialize(curr_env_file, env_params)
  prob.initialize(e, lattice, cost_fn, heuristic_fn, start_n, goal_n, visualize=False)
  planner_local.initialize(prob) 
  path, path_cost, num_expansions, plan_time, came_from, cost_so_far, c_obs = planner_local.plan()
